...
?>
                <tr bgcolor="#d3d3d3" style="text-align:center;">
                    ...
                    <td style="text-align:center;">
                        <input type="button" value="Editar" onclick="location.href='EditarVenda.php?idVenda=<?php echo $linha['idVenda'] ?>'">
                        <input type="button" value="Excluir" onclick="location.href='ExcluirVenda.php?idVenda=<?php echo $linha['idVenda'] ?>'">
                    </td>
                </tr>
<?php
    }
